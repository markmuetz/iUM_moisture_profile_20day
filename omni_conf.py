...
for expt in expts:
    ...
    comp['dirs']['results_' + expt] = '/nerc/n02/n02/mmuetz/omni_output/iUM_moisture_profile_20day/results_{}'.format(expt)
...
for expt in expts:
    groups['pp5_' + expt] = {
	    ...
	    'base_dir': 'work_' + expt,
	    'batch': 'batch0',
	    'filename_glob': '2000??????????/atmos/atmos.???.pp5',
	    }
